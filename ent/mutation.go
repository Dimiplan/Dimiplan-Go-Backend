...
func (m *MessageMutation) ChatroomIDs() (ids []int) {
...
func (m *MessageMutation) ResetChatroom() {
	m.chatroom = nil
...
func (m *MessageMutation) AddedEdges() []string {
	...
	if m.chatroom != nil {
		edges = append(edges, message.EdgeChatroom)
	}
	return edges
}
