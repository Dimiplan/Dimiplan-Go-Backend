...
func (_c *UserCreate) SetProfileURL(v string) *UserCreate {
...
func (_c *UserCreate) AddPlannerIDs(ids ...int) *UserCreate {
	_c.mutation.AddPlannerIDs(ids...)
	return _c
}

// AddPlanners adds the "planners" edges to the Planner entity.
func (_c *UserCreate) AddPlanners(v ...*Planner) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.ProfileURL(); !ok {
		return &ValidationError{Name: "profileURL", err: errors.New(`ent: missing required field "User.profileURL"`)}
	}
